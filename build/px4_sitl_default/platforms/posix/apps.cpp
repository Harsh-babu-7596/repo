...
int rover_ackermann_main(int argc, char *argv[]);
int rover_differential_main(int argc, char *argv[]);
int rover_mecanum_main(int argc, char *argv[]);
int rover_pos_control_main(int argc, char *argv[]);
int sensors_main(int argc, char *argv[]);
int battery_simulator_main(int argc, char *argv[]);
int gz_bridge_main(int argc, char *argv[]);
...
void init_app_map(apps_map_type &apps)
{
	...
	apps["rover_ackermann"] = rover_ackermann_main;
	apps["rover_differential"] = rover_differential_main;
	apps["rover_mecanum"] = rover_mecanum_main;
	apps["rover_pos_control"] = rover_pos_control_main;
	apps["sensors"] = sensors_main;
	apps["battery_simulator"] = battery_simulator_main;
	apps["gz_bridge"] = gz_bridge_main;
