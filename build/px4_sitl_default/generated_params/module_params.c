 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RA_MISS_SPD_DEF, 2);
 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RA_MAX_THR_SPEED, -1);
 ...
 * @unit m/s^2
 */
PARAM_DEFINE_FLOAT(RA_MAX_DECEL, -1);
 ...
 * @unit m/s^2
 */
PARAM_DEFINE_FLOAT(RA_MAX_LAT_ACCEL, 0.01);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RA_LAT_ACCEL_P, 0);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RA_LAT_ACCEL_I, 0);
 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RD_MAX_THR_SPD, 1);
 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RD_MAX_THR_YAW_R, 2);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(RM_MAN_YAW_SCALE, 1);
 ...
 * @unit m
 */
PARAM_DEFINE_FLOAT(RM_WHEEL_TRACK, 0.5);
 ...
 * @unit deg/s
 */
PARAM_DEFINE_FLOAT(RM_MAX_YAW_RATE, 90);
 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RM_MAX_THR_YAW_R, 2);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RM_YAW_RATE_P, 1);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RM_YAW_RATE_I, 0);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RM_YAW_I, 0.1);
 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RM_MAX_SPEED, 7);
 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RM_MAX_THR_SPD, 1);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RM_SPEED_P, 1);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RM_SPEED_I, 0);
 ...
 * @unit m/s^3
 */
PARAM_DEFINE_FLOAT(RM_MAX_JERK, 0.5);
 ...
 * @unit m/s^2
 */
PARAM_DEFINE_FLOAT(RM_MAX_ACCEL, 0.5);
 ...
 * @unit m/s
 */
PARAM_DEFINE_FLOAT(RM_MISS_SPD_DEF, 1);
 ...
 * @max 100
 */
PARAM_DEFINE_FLOAT(RM_MISS_VEL_GAIN, 1);
