...
alias rover_ackermann='px4-rover_ackermann --instance $px4_instance'
alias rover_differential='px4-rover_differential --instance $px4_instance'
alias rover_mecanum='px4-rover_mecanum --instance $px4_instance'
...
alias gz_bridge='px4-gz_bridge --instance $px4_instance'
